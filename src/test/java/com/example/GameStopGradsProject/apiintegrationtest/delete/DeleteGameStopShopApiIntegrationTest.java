...
public class DeleteGameStopShopApiIntegrationTest {
    ...
    @Test
    @DisplayName("""
            If the following endpoint DELETE /gamestopshops/deletion/{id} is called and
            the id exists in the game_stop_shop table, then the HTTP response should be
            200 OK.
            """)
    ...
    void Test1() throws Exception {
        ...
        mockMvc.perform(delete("/gamestopshops/deletion/" + id))
    ...
    @DisplayName("""
            If the following endpoint DELETE /gamestopshops/deletion/{id} is called and
            the id does not exist in the game_stop_shop table, then the HTTP response should be
            404 NOT FOUND.
            """)
    @WithMockUser(username = "anything", password = "anything", authorities = {"read", "write"})
