...
public class DeleteEmployeeApiIntegrationTest {
    ...
    @Test
    @DisplayName("""
            If the following endpoint DELETE /employees/deletion/{id} is called and
            the id exists in the employee table, then the HTTP response should be
            200 OK.
            """)
    ...
    void Test1() throws Exception {
        ...
        mockMvc.perform(delete("/employees/deletion/" + id))
    ...
    @DisplayName("""
            If the following endpoint DELETE /employees/deletion/{id} is called and
            the id does not exist in the employee table, then the HTTP response should be
            404 NOT FOUND.
            """)
    @WithMockUser(username = "anything", password = "anything", authorities = {"read", "write"})
