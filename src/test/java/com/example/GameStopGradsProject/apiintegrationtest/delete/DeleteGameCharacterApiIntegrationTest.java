...
public class DeleteGameCharacterApiIntegrationTest {
    ...
    @Test
    @DisplayName("""
            If the following endpoint DELETE /gamecharacters/deletion/{id} is called and
            the id exists in the game_character table, then the HTTP response should be
            200 OK.
            """)
    ...
    void Test1() throws Exception {
        ...
        mockMvc.perform(delete("/gamecharacters/deletion/" + id))
    ...
    @DisplayName("""
            If the following endpoint DELETE /gamecharacters/deletion/{id} is called and
            the id does not exist in the game_character table, then the HTTP response should be
            404 NOT FOUND.
            """)
    @WithMockUser(username = "anything", password = "anything", authorities = {"read", "write"})
